...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Vector3 PixelPerfectClamp(Vector3 change, float pixelsPerUnit)
    {
        Vector3 vectorInPixels = new Vector3(
            Mathf.RoundToInt(change.x * pixelsPerUnit),
                        Mathf.RoundToInt(change.y * pixelsPerUnit),
                                    Mathf.RoundToInt(change.z * pixelsPerUnit));
    ...
    void LateUpdate()
    {
        ...
        change = PixelPerfectClamp(change, pixelsPerUnit);
